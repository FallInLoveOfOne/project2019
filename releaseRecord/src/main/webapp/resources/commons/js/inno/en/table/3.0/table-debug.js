define("inno/en/table/3.0/table",function(require, exports, module){
	var $=require("$");
	...
	var Table={
		...
		congelationTitle:function( html ){
			...
			xtitle.css({"top":"0px","left":(width+pright+pleft+1)+"px"});
			ytitle.css({"top":height+1+"px","left":"0px"});
			if( pwidth ){
		...
		bindScrollEvent:function(parent,title,xtitle,ytitle,width,height,rtile){
			parent.scroll(function(){
				...
				xtitle.css({"top":scrollTop+"px","left":width+1+"px"});
				ytitle.css({"top":height+1+"px","left":scrollLeft+"px"});
			});
		}
...
define("inno/en/table/3.0/table2",function(require, exports, module){
	var $=require("$");
...
define("inno/en/table/3.0/table-debug",function(require,exports, module){
	var $=require("$");
	var Table=require("./table");
...
//				}
		...
		getIcmeta:function(){
			...
			var parameter={
			     url:"http://" + hostname + ":" + port + projectName +"/bill/common/get/icmeta/instance",
		...
		getValue:function(){
			...
			var projectName=pathName.substring(0,pathName.substr(1).indexOf('/')+1);
			var parameter={
			     url:"http://" +hostname + ":" + port + projectName +"/bill/common/get/value",
			     data:{ rmodelId : _this.attrs.tableId },
			     success:function(data){
		...
		getImeta:function(){
			...
			var projectName=pathName.substring(0,pathName.substr(1).indexOf('/')+1);
			var parameter={
			     url:"http://" +hostname + ":" + port + projectName +"/bill/common/get/imeta/instance",
			     data:{ rmodelId : _this.attrs.tableId },
			     success:function(data){
		...
		getLayoutCfg:function(){
			...
			var projectName=pathName.substring(0,pathName.substr(1).indexOf('/')+1); 
			var parameter={
				 url:"http://" +hostname + ":" + port + projectName +"/bill/common/get/layout",
			     type:"POST",
			     data:{ rmodelId : _this.attrs.tableId },
			     success:function(data){
