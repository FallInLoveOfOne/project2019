define(function(require){
    ...
    layui.use('table', function(){
        ...
        table.render({
            ...
            cols: [[
                ...
                //{field:'HOLD_END', width: '11%', title: '拘留到期日期',templet:function(d){return dateFormat(d.HOLD_END)}},// dateFormat
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'detail'){
            	...
            	comebackOpt(personNumber);// 回所操作2018-10-15
            }
        });
    });
    }
  ...
  //判断两个时间控件如果都为空则去除快捷选择
    ...
    function getQuery(){
    	...
    	queryObj.outType="temp";//$("input[name='outType']:checked").val();// 异常类型，获取radio的选中值
    	return queryObj;
    }
    ...
    function comebackOpt(id){
    	...
    	var dataNum = 0;
    	var param = {// 判断是否有记录、下一步、当前日期
				url:address+"evidence/comeBackOpt",
				type:"POST",
				data:{number:id},
				//beforeSend:function(){},
				//async:false,
