...
<head>
    ...
    <link rel="stylesheet" href="../../releaseRecord/dataInterfaceManage/css/interfaceCallStatistics.css" />
</head>
<body>
<div class="content">
                ...
                <div class="ipt-date">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            ...
                            <i class="iconfont-sy">&#xe753;</i><input type="text" class="layui-input" id="test-out-start"placeholder=" 2018-04-21"><i class="iconfont-sy">&#xe754;</i>
                        </div>
                    </div>
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            ...
                            <i class="iconfont-sy">&#xe753;</i><input type="text" class="layui-input" id="test-out-end" placeholder="2018-04-21"><i class="iconfont-sy">&#xe754;</i>
                        </div>
                    </div>
                    <div class="layui-inline btn-title">快捷选择:</div>
                    <div class="layui-inline time-btn today-btn">今天</div>
                    <div class="layui-inline time-btn week-btn cktimebtn">本周内</div>
    ...
    <div class="content-bottom">
        <div class="tab-table">
            <div class="excel-statis table-bar choosen-tab">
                <i class="iconfont-sy tab-pic">&#xe73e;</i><span>表格统计</span>
            </div>
            <div class="table-analyze table-bar">
...
<script>
    ...
    seajs.use('<%=basePath%>/releaseRecord/dataInterfaceManage/js/interfaceCallStatistics.js');
</script>
</html>
