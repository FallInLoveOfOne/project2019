define("inno/en/table/3.1/table",function(require, exports, module){
	var $=require("$");
...
define("inno/en/table/3.1/table2",function(require, exports, module){
	var $=require("$");
...
define("inno/en/table/3.1/table-debug",function(require,exports, module){
	var $=require("$");
	var Table=require("./table");
...
//				}
		...
		getIcmeta:function(){
			var _this = this;
			var parameter={
			     url:"rmodelHz/get/icmeta/instance",
		...
		getImeta:function(){
			var _this = this;
			var parameter={
			     url:"rmodelHz/get/imeta/instance",
			     data:{ rmodelId : _this.attrs.tableId },
			     success:function(data){
