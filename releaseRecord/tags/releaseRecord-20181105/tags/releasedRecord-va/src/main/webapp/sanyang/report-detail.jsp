...
<html lang="en">
                    ...
                    <div class="middle-box">
                        ...
                        <div class="person-info clearfix">
                            <div class="person-img fl">
                                <img id="personPhoto" src="imgs/detail_01_03.jpg" alt="">
                            </div>
                            ...
                            <div data-method="offset" data-type="auto" class="report-confirm-btn" style="cursor: pointer">确认</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
		...
		var outDocSta_="${userObj.OUT_DOC_STATE}";
		var photo_ = "${userObj.photoPath}";
		var perBirth="${userObj.BIRTH}";
        seajs.use("<%=basePath%>sanyang/js/report-detail.js")
    </script>
</html>