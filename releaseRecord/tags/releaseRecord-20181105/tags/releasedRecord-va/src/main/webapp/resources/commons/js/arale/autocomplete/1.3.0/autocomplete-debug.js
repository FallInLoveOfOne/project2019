define("autocomplete", [ "$", "overlay", "position", "iframe-shim", "widget", "base", "class", "events", "templatable", "handlebars", "./data-source-debug", "./filter-debug", "./input-debug", "./autocomplete-debug.handlebars","../../../../css/alice/base/1.0.1/base.css","../../../../css/alice/select/1.0.0/select.css"], function(require, exports, module) {
    var $ = require("$");
