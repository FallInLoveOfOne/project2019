...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span>将文件拖拽到这里，或者</span>",
            uploadStr:"打开",
            dragDropStr2: "<span>文件夹</span>",
            abortStr: "上传中。。。",
            cancelStr: "Cancel",
            deleteStr: "Delete",
            doneStr: "Done",
        ...
        (function checkAjaxFormLoaded() {
            if($.fn.ajaxForm) {
                ...
                if(s.dragDrop) {
                    var dragDrop = $('<div class="' + s.dragDropContainerClass + '" style=""></div>').width(s.dragdropWidth);
                    $(obj).append(dragDrop);
                    $(dragDrop).append($(s.dragDropStr));
                    $(dragDrop).append(uploadLabel);
                    $(dragDrop).append($(s.dragDropStr2));
