        ...
        $.fn.jOrgChart.util = {
            ...
            buildNode: function ($nodeList, $appendTo, level, opts) {
                ...
                for (var i = 0, len = $nodeList.length; i < len; i++) {
                    ...
                    if(opts.showStatus){
                        var $nodeContent ="<h3 class='node-title'>" + $node.nodeContent + "</h3><span class='node-content'>下级:"+ ($node.nodeCount || "0") +"家</span><div class='node-tool-bar'><a class='iconfont node-edit'>&#xf0032;</a><a class='iconfont node-add'>&#xf00bd;</a><a class='iconfont node-delete'>&#xf00a5;</a><a class='iconfont node-show'>&#xf00bb;</a></div>";
                    }else{
                        var $nodeContent ="<h3 class='node-title'>" + $node.nodeContent + "</h3><span class='node-content'>下级:"+ ($node.nodeCount || "0") +"家</span><div class='node-tool-bar'><a class='iconfont node-edit'>&#xf0032;</a><a class='iconfont node-add'>&#xf00bd;</a><a class='iconfont node-delete'>&#xf00a5;</a></div>";
                    }
