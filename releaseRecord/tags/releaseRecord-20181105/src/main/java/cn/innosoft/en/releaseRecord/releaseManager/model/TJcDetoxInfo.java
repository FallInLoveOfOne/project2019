...
/**
 * The persistent class for the T_JC_DETOX_INFO database table.
 * 
 */
@Entity
@Table(name="T_JC_DETOX_INFO")
@NamedQuery(name="TJcDetoxInfo.findAll", query="SELECT t FROM TJcDetoxInfo t")
public class TJcDetoxInfo implements Serializable {
