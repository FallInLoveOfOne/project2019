...
<html lang="en">
                    ...
                    <div class="ipt fl">
                        <div class="ipt-people clearfix">
                            <div class="people-wait fl">
                                <label class="layui-form-label">未人员姓名</label><div class="layui-input-block">
    ...
    <script type="text/html" id="titleTpr">
        ...
        <a class="layui-btn layui-btn-xs out-office" lay-event="edit">出所</a>
    </script> 
    <script>
    	var address = "<%=basePath%>";
    	var jsonQuery="${jsonQuery}";
    	var id_ = "${jsonQuery.ID}";
        seajs.use(['<%=basePath%>sanyang/js/layout.js','<%=basePath%>sanyang/js/temp.js', '<%=basePath%>sanyang/js/getDate.js', '<%=basePath%>sanyang/js/setPlaceholder.js'])
    </script>
</html>